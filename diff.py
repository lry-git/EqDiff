...
sys.path.append('.')
from pack.config import out_dir
from pack.file_sys import *

def diff(csv_w,filepath,combs):     
    for comb in combs:
        diff_res=diffFiles(os.path.join(filepath,comb[0]),os.path.join(filepath,comb[1]))        
        csv_w.writerow(diff_res)
            
if __name__ == "__main__":       
    comp_path='/mnt/d/AppData/WSL/projects/empirical-study/input/Linux_compare-2'
    # comp_path='/mnt/d/AppData/WSL/projects/empirical-study/test'
